...
<body style="border-style:none; background-image: url('${pageContext.request.contextPath}/images/login.jpg');background-repeat: no-repeat;  background-attachment: fixed; background-size:100% 100%; min-width: 1010px; height: 550px; margin-top: -30px;margin-left: 10px;">
 ...
 <ul class="layui-nav ">
  <li class="layui-nav-item layui-this"><a target="mainall" href="${pageContext.request.contextPath}/comiss/comissList.do">首页</a></li>
  <li class="layui-nav-item ">
    <a href="javascript:;">我的工作</a>
    <dl class="layui-nav-child ">
     <dd><a target="mainall" href="${pageContext.request.contextPath}/receiptsList.jsp" >电子单据列表</a></dd>
      <dd style="margin-top: 10px;"><a target="mainall" href="${pageContext.request.contextPath}/leave.jsp" >请假电子单据</a></dd>
       <dd style="margin-top: 10px;"><a target="mainall" href="${pageContext.request.contextPath}/evection.jsp">出差电子单据</a></dd>
      <dd style="margin-top: 10px;"><a target="mainall" href="${pageContext.request.contextPath}/forget.jsp">忘打卡电子单据</a></dd>
    </dl>
  </li>
  ...
  <li class="layui-nav-item"><a href="javascript:;">基本信息管理</a>
      ...
      <dd style="margin-top: 10px;"><a target="mainall" href="${pageContext.request.contextPath}/adept.jsp">部门信息管理</a></dd>
    </dl>
  </li>
   </c:if> 
  <li class="layui-nav-item">
    ...
    <dl class="layui-nav-child">
      <dd><a target="mainall" href="${pageContext.request.contextPath}/punchList.jsp">考勤信息列表</a></dd>
          <c:if test="${roleBean.g_role_status==1}"> 
      <%--<dd style="margin-top: 10px;" ><a target="mainall" href="${pageContext.request.contextPath}/punchListBean.jsp" >月考勤统计</a></dd>--%>
         </c:if>
    </dl>
    
  </li>
  <c:if test="${roleBean.g_role_status==1}"> 
    <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/login/usertab.do" target="mainall">系统用户管理</a></li>
     </c:if> 
	...
	<div align="right" style="margin-top: -30px;color: #ffffff;">
                 <span  style="color: white; text-align: center;">欢迎${eBean.role_name }【${eBean.login_name }】登陆考勤管理系统</span>
  </div>
</ul>
 
</div>
<iframe name="mainall" src="${pageContext.request.contextPath}/comiss/comissList.do" frameborder="0" width="100%" height="450px;" scrolling="auto">
</iframe>
</body>
</html>